...
namespace SportsStore.Data
{
    public class ApplicationDbContext:DbContext
    {
        ...
        private void MapCustomer(EntityTypeBuilder<Customer> c)
        {
            ...
            c.HasOne(t => t.City).WithMany().IsRequired().OnDelete(DeleteBehavior.Restrict);
            c.HasMany(t => t.Orders).WithOne().IsRequired().OnDelete(DeleteBehavior.Cascade);
        }
        ...
        private static void MapOrderLine(EntityTypeBuilder<OrderLine> ol)
        {
            ...
            ol.HasOne(t => t.Product).WithMany().IsRequired().HasForeignKey(t => t.ProductId).OnDelete(DeleteBehavior.Restrict);
        }
        ...
        private static void MapOrder(EntityTypeBuilder<Order> o)
        {
            ...
            o.HasOne(t => t.ShippingCity).WithMany().IsRequired().OnDelete(DeleteBehavior.Restrict);
            o.HasMany(t => t.OrderLines).WithOne().IsRequired().HasForeignKey(t => t.OrderId).OnDelete(DeleteBehavior.Cascade);
